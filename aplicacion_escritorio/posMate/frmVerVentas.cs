...
namespace CapaPresentacion
{
    public partial class frmVerVentas : Form
    {
        ...
        private async void dgvDataVenta_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (index != -1)
            {
                ...
                List<DetalleVenta> detallesVenta = await negocioDetalleVenta.ObtenerDetallesVentaAsync(idVenta);
        ...
        private async void ddlUsuarios_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (usuarioSeleccionado == "Todos los usuarios")
            {
                ...
                List<Venta> ventas = await negocioVenta.ObtenerVentasAsync();
            ...
            else
            {
                ...
                CN_Venta negocioVenta = new CN_Venta();
                List<Venta> ventas = await negocioVenta.ObtenerVentasAsync(idUsuario);
