...
set -a && . ../backend/.env &&  DB_CONNECTION_STRING=mssql://$DB_USER:$DB_PASS@$DB_HOST:$DB_PORT/$DB_NAME && set +a &&  echo "Generando procedimientos $DB_CONNECTION_STRING" && npx yo mssql-types ./templates
