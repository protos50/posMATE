...
// Endpoint para agregar un detalle de venta
router.post('/detalleventa', (req, res) => {
    console.log("POST : /detalleventa");
    const detalleVenta = req.body;

    console.log("DetalleVenta recibido:", detalleVenta);

    // Simular la inserción de un detalle de venta
