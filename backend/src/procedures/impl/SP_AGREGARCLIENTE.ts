...
//export class SP_AGREGARCLIENTE {
 ...
 export const execute = async(params: Params): Promise<sql.IProcedureResult<Result>> => {
    ...
    // const procedure = new Procedure<Result>('SP_AGREGARCLIENTE');
    ...
    const recordsets = await request.execute<Result>('SP_AGREGARCLIENTE');
    console.log("RecordSet SP_AGREGARCLIENTE",recordsets)
    return recordsets
