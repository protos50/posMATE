...
//export class SP_OBTENERCATEGORIASMASVENDIDAS {
 ...
 export const execute = async(params: Params): Promise<sql.IProcedureResult<Result>> => {
    ...
    // const procedure = new Procedure<Result>('SP_OBTENERCATEGORIASMASVENDIDAS');
    ...
    const recordsets = await request.execute<Result>('SP_OBTENERCATEGORIASMASVENDIDAS');
    console.log("RecordSet SP_OBTENERCATEGORIASMASVENDIDAS",recordsets)
    return recordsets
