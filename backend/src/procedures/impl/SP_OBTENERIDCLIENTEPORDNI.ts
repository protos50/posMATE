...
//export class SP_OBTENERIDCLIENTEPORDNI {
 ...
 export const execute = async(params: Params): Promise<sql.IProcedureResult<Result>> => {
    ...
    // const procedure = new Procedure<Result>('SP_OBTENERIDCLIENTEPORDNI');
    ...
    const recordsets = await request.execute<Result>('SP_OBTENERIDCLIENTEPORDNI');
    console.log("RecordSet SP_OBTENERIDCLIENTEPORDNI",recordsets)
    return recordsets
