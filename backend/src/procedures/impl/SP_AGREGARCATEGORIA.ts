...
//export class SP_AGREGARCATEGORIA {
 ...
 export const execute = async(params: Params): Promise<sql.IProcedureResult<Result>> => {
    ...
    // const procedure = new Procedure<Result>('SP_AGREGARCATEGORIA');
    ...
    const recordsets = await request.execute<Result>('SP_AGREGARCATEGORIA');
    console.log("RecordSet SP_AGREGARCATEGORIA",recordsets)
    return recordsets
