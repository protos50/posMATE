...
//export class SP_AGREGARPRODUCTO {
 ...
 export const execute = async(params: Params): Promise<sql.IProcedureResult<Result>> => {
    ...
    // const procedure = new Procedure<Result>('SP_AGREGARPRODUCTO');
    ...
    const recordsets = await request.execute<Result>('SP_AGREGARPRODUCTO');
    console.log("RecordSet SP_AGREGARPRODUCTO",recordsets)
    return recordsets
